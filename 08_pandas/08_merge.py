...
"""
    시세(prices) 90,00행에 섹터이름을 매번 저장하면
            같은 문자열이 수천번 반복될 것임!
...
# => 두 df의 기준열을 모두 가진 새로운 DateFrame 변환됨
...
print(f" prices + companies :: how=inner=left ")
...
# 2. 대소문자
print(f" === 대소문자 체크 === ")
print(f" market 종류 : {raw_comp['market'].nunique()}개 : {raw_comp['market'].unique()}개")
